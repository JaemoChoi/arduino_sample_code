...
FFPLAY_PATH = r"C:\Home_cafe\ffmpeg-2025-09-10-git-c1dc2e2b7c-full_build\bin\ffplay.exe"
...
# 설정 파일 경로
CONFIG_FILE = r"C:\Home_cafe\config.txt"
...
# 합쳐진 동영상 파일 경로
videos = {
    "1": r"C:\Home_cafe\Video\H1.mp4",
    "2": r"C:\Home_cafe\Video\H2.mp4",
    "3": r"C:\Home_cafe\Video\H3.mp4",
    "4": r"C:\Home_cafe\Video\H4.mp4",
    "5": r"C:\Home_cafe\Video\H5.mp4",
    "6": r"C:\Home_cafe\Video\H6.mp4",
    "7": r"C:\Home_cafe\Video\H7.mp4",
    "8": r"C:\Home_cafe\Video\H8.mp4",
    "9": r"C:\Home_cafe\Video\H9.mp4",
    "10": r"C:\Home_cafe\Video\H10.mp4"

}

# MP3 파일 경로
audios = {
    "9": r"C:\Home_cafe\Audio\audio1.mp3",
    "b": r"C:\Home_cafe\Audio\audio2.mp3",
    "c": r"C:\Home_cafe\Audio\audio3.mp3"
}

# 듀얼 모니터 해상도 설정 (예: 1920x1080 모니터 2개)
monitor_width = 3840  # 가로 해상도
monitor_height = 2160  # 세로 해상도
