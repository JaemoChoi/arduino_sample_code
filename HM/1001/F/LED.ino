...
void REAR_setPixel(int Pixel, byte red, byte green, byte blue, byte white) {

  REAR_strip.setPixelColor(Pixel, REAR_strip.Color(red, green, blue, white));
}
...
void EAR_setAll(byte red, byte green, byte blue, byte white) {
  for (float dim = 0; dim < 256; dim++) {
    for (int i = 0; i < EAR_NUM; i++) {
      ...
      REAR_setPixel(i, red * (dim / 255), green * (dim / 255), blue * (dim / 255), white * (dim / 255));
    }
    EAR_strip.show();
    REAR_strip.show();
  }
...
void All_Light_On_dimmed(byte red, byte green, byte blue, byte white) {
  float dim = 255;
  for (int i = 0; i < EAR_NUM; i++) {
    EAR_setPixel(i, red * (dim / 255), green * (dim / 255), blue * (dim / 255), white * (dim / 255));
    REAR_setPixel(i, red * (dim / 255), green * (dim / 255), blue * (dim / 255), white * (dim / 255));
...
void All_Light_Off(byte red, byte green, byte blue, byte white, float dimmed) {
  float dims = 0;
  for (float dim = 255; dim > dimmed; dim -= 2) {
    for (int i = 0; i < EAR_NUM; i++) {
      EAR_setPixel(i, red * (dim / 255), green * (dim / 255), blue * (dim / 255), white * (dim / 255));
      REAR_setPixel(i, red * (dim / 255), green * (dim / 255), blue * (dim / 255), white * (dim / 255));
    }
