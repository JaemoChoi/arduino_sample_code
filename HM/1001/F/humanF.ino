...
uint8_t r2 = 149, g2 = 184, b2 = 255, w2 = 0;  // 두 번째 색상
...
void loop() {
  ...
  if (SCENE_NO == 4) {  // SCENE NO 4 : Working xxxxxxxxxxxxxxx
    Serial.println(SCENE_NO);
    All_Light_On_dimmed(0, 0, 0, 20);
    led_flag = 0;
    SCENE_NO = 255;
  ...
  if (SCENE_NO == 6) {  // SCENE 5 : Communication xxxxxxxxxxxxxxxxxxx
    Serial.println(SCENE_NO);
    All_Light_On_dimmed(0, 0, 0, 20);
    led_flag = 0;
    SCENE_NO = 255;
